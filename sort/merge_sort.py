...
def sortArray(leftArray, rightArray, asc):
    ...
    while i < len(leftArray) and j < len(rightArray):
        ...
        print("SortedArray[k]", sortedArray[k])
        print("leftArray to sort - ", leftArray)
        print("rightArray to sort- ", rightArray)
        # print("leftArray[i]", leftArray[i])
        # print("rightArray[j]", rightArray[j]) 
        print("I index position - ", i)
        print("J index position - ", j)
        print("k index position - ", k)
